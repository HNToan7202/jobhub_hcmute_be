...
public class EmployerServiceImpl extends RedisServiceImpl implements EmployerService {
    ...
    @Override
    public ActionResult top3Company() {
        ActionResult actionResult = new ActionResult();
        List<Employer> employers = employerRepository.findTop3ByTransactionMoneyGreaterThanEqualOrderByTransactionMoneyDesc(1L);
        actionResult.setData(employers);
        actionResult.setErrorCode(ErrorCodeEnum.OK);
        return actionResult;
    }
